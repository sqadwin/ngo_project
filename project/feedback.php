...
<div class="col-lg-6">
<span class="logo">Exam Portal</span></div>
<div class="col-md-2">
</div>
<div class="col-md-4">
<?php
...
<div class="col-md-10">
<a href="abhisinghbhu55@gmail.com" style="color:#000000">examportal@gmail.com</a><br /><br />
...
<a href="" target="_blank">Job Portal</a>
</div>
<div class="col-md-3 box">
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div class="row">
		<div class="col-md-4">
		 <img src="image/abhimg.jpg" width=100 height=100 alt="Abhinav Singh" class="img-rounded">
		 </div>
		 <div class="col-md-5">
		<a href="" style="color:#202020; font-family:'typo' ; font-size:18px" title="Find on Facebook">Abhinav Singh</a>
		<h4 style="color:#202020; font-family:'typo' ;font-size:16px" class="title1">+91 7510037451</h4>
		<h4 style="font-family:'typo' ">abhisinghbhu55@gmail.com</h4>
		<h4 style="font-family:'typo' ">United Insitute of Technology ,prayagraj</h4></div></div>
		</p>
      </div>
